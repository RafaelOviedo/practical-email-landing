...
<code>
  &lt;form
    action="https://practical-email.vercel.app/email/your@email.com" 
    method="POST"
  &gt;
    &lt;input
      type="text"
...
<code>
  ...
  const data = {
    name: 'John Doe',
    email: 'john@mail.com',
    message: 'Hey this is John'
  }

  async function sendEmail() {
    await axios.post('https://practical-email.vercel.app/email/your@email.com', data);
  }
